...
> **2026-07-19 复核说明：** 本文保留 2026-07-02 的首轮探索数据作为历史记录。预训练权重容量质量、专家数/容量扫描、NCCL、桶级 ready/complete 时间线、通信压力、物理慢卡和真实 DataLoader 受控采样已在 [EXP-INFRA-03](EXP-INFRA-03-grouped-moe-ddp-evidence.md) 中完成；关于“5.9% 纯通信开销”和“质量尚未量化”的旧结论，以 EXP-INFRA-03 的隔离测量为准。CUDA Event 复测给出的末桶完成上界为 4 卡 0.91 ms、8 卡 6.41 ms，default−noop 区间仍跨 0；保持全局样本集合不变后，任务均衡为 496.84 vs 496.43 ms，没有性能收益。
